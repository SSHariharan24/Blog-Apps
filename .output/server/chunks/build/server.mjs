...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DbH0ADNL.mjs')
  },
  {
    name: "create",
    path: "/create",
    component: () => import('./create-SuIMdQOH.mjs')
  },
  {
    name: "edit-id",
    path: "/edit/:id()",
    component: () => import('./_id_-CE_UfmYh.mjs')
  },
  {
    name: "view-id",
    path: "/view/:id()",
    component: () => import('./_id_-DRZLcg4H.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D2yWPNnv.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C0w_xksq.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, asyncDataDefaults as e, createError as f, fetchDefaults as g, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
